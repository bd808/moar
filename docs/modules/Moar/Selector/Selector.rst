...
.. php:class:: Selector
    ...
    The selector is configured using a language that uses periods (`.`) to indicate member selection and brackets (`[]`) for array indexing. It also provides a CSS3-inspired mechanism to select array members tht have content matching a specified value. See {@link Moar\Selector\Parser} for full language grammar and examples.

    .. php:attr:: instructions

        protected array

        Instructions for this selector.

    .. php:attr:: throwExceptions
    ...
    .. php:attr:: lastError
        ...
        protected Moar\Selector\TraversalException
